...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Inizializzo una nuova sessione se questa non fosse già inizializzata
            ...
            for(Utente u : listaUtenti)
            {
                   ...
                   u.getPassword().equals(password))
                {
                    ...
                    if(u instanceof Amministratori) 
                    {
                      ...
                      //permetto all'amministratore di vedere i post che altri utenti hanno messo prendendoli
                      //dalla lista di Array che li contiene  
                      PostFactory factory =  new PostFactory();        
                      List<Post> post = factory.getPostList(); 
